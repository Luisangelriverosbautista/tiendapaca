          ...
          <div class="row g-0">
            ...
            <div class="col-md-6">
              <div class="position-relative h-100">
                <img 
                  src="https://cdn.businessinsider.es/sites/navi.axelspringer.es/public/media/image/2020/09/reloj-inteligente-banlvs-2069621.jpg?tf=3840x" 
                ...
                <div class="position-absolute bottom-0 start-0 w-100 bg-white bg-opacity-75 p-2">
                  <div class="d-flex justify-content-center align-items-center">
                    ...
                    <span class="small">4.0 (89 reseñas)</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="card-body h-100 d-flex flex-column">
                <h2 class="card-title fw-bold mb-3">Reloj Inteligente Galaxy</h2>
                
                <!-- Precios -->
                <div class="mb-3">
                  <span class="text-danger fs-4 fw-bold">$2,890.00</span>
                  <span class="text-decoration-line-through text-muted ms-2">$3,400.00</span>
                  <span class="badge bg-success ms-2">Ahorras $510</span>
                </div>
                
                <!-- Descripción -->
                <p class="card-text mb-4">
                  Reloj inteligente con pantalla Super AMOLED, monitoreo de salud, GPS integrado y conectividad total con tu smartphone. Perfecto para deportistas y uso diario.
                </p>
                ...
                <ul class="list-group list-group-flush mb-4">
                  <li class="list-group-item d-flex align-items-center">
                    ...
                    Pantalla de 1.5” Super AMOLED
                  </li>
                  <li class="list-group-item d-flex align-items-center">
                    <i class="bi bi-patch-check-fill text-primary me-2"></i>
                    Monitor de ritmo cardíaco y sueño
                  </li>
                  <li class="list-group-item d-flex align-items-center">
                    <i class="bi bi-patch-check-fill text-primary me-2"></i>
                ...
                <div class="mb-4">
                  ...
                  <div class="d-flex gap-2">
                    <button class="btn btn-outline-secondary">Negro</button>
                    <button class="btn btn-outline-secondary">Plata</button>
                    <button class="btn btn-outline-secondary">Azul</button>
                  </div>
                </div>
